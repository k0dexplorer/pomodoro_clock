        ...
        return (
            <div>
                ...
                <div className="flex play-button">
                        <button id="start_stop" onClick={this.handlePlayPause}><i className={`fas fa-${isPlaying ? 'pause' : 'play'}`}></i></button>
    ...
    return (
        <div className="timer-container">
            ...
            <div className="flex actions-wrapper">
                <button id={`${id}-decrement`} onClick={props.handleDecrease}><i className="fas fa-minus"></i></button>
                <span id={`${id}-length`}>{props.count}</span>
                <button id={`${id}-increment`} onClick={props.handleIncrease}><i className="fas fa-plus"></i></button>
            </div>
        </div>
    );
}
